		...
		class tvr_microthemer_admin {
			...
			function __construct(){
				...
				if ( is_admin() and in_array($page, $this->all_pages) ) {
						...
						'view' => array(
							...
							'sub' => array(
								...
								'enable_beaver_builder' => array(
									...
									'data-neg' => esc_attr__('Disable Beaver Builder', 'microthemer'),
								),
								'highlighting' => array(
					...
					// check is interateable plugins are active
						...
						foreach ($arr['sub'] as $item_key => $arr2){
							...
							if (isset($arr2['input'])){
								...
								<div class="combobox-wrap tvr-input-wrap hidden">
									<input type="text" name="set_preview_url" class="combobox has-arrows"
									rel="'.$arr2['combo_data'].'"
									value="'.$arr2['input'].'" />
		...
		class tvr_microthemer_frontend {
			...
			*/
			...
			function currentPageURL() {
				...
				//}
				// this old function was including the port number, not sure why.
				$curpageURL.= $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"];
				return $curpageURL;
			}
